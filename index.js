...
const ARGO_DOMAIN = process.env.ARGO_DOMAIN || 'godlike.admire.cc.cd';          // 固定隧道域名,留空即启用临时隧道
const ARGO_AUTH = process.env.ARGO_AUTH || 'eyJhIjoiMDI5YmU0Y2RiZTc5MGE1ZDQ4NTg1OTUzYzMwNjljZTMiLCJ0IjoiMjQ1MTc3OWEtY2JkNS00ZGE5LWEwYTAtZGNiZjMzNmE0YTc0IiwicyI6Ik1qZ3hNMk5oT1RrdE1ETXdOaTAwTURRNExXRXlNbVV0T0dZMk9UVmlZbUZqTWpZMSJ9';              // 固定隧道密钥json或token,留空即启用临时隧道,json获取地址：https://json.zone.id
